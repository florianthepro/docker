...
First download the script file setup-minecraft-full.sh so that it is placed loosely in your Downloads folder on Windows.
It should look like this:

C:\Users\<YourWindowsUser>\Downloads\setup-minecraft-full.sh
...
chmod +x setup-minecraft-full.sh
./setup-minecraft-full.sh
